...
- DB(rover_database.db)のテーブル作成
- routes以外のテーブルを初期化(DELETE)
- adminユーザーを作成
- sample_images→static/photosへコピーし photos テーブルへ登録
"""
import sqlite3
import os
