...
DATASET_MAPPING = {
    "normal": os.path.join(script_dir, "dataset", "normal"),
    "disease":os.path.join(script_dir,"dataset","disease")
}
...
if len(features) == 0:
    ...
    stratify_option = labels if len(LABELS) > 1 else None

    X_train, X_test, y_train, y_test = train_test_split(
        features, labels, test_size=0.2, random_state=42, stratify=stratify_option
    )
